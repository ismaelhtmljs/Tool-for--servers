...
def window_client():
    while True:
        ...
        if respuesta_cliente == "1":
            ...
            # Convertir el puerto a entero para validarlo
            try:
                ...
                if port_entry < 1 or port_entry > 65535:
                    ...
                    continue  # Retornar si el puerto no es válido
            except ValueError:
                print(Fore.RED + "Error: El puerto debe ser un número válido.")
                continue  # Retornar si la conversión a entero falla

            # Crear el socket para el cliente (IPv4)
            ...
            try:
                ...
                if port_entry < 1 or port_entry > 65535:
                    print(Fore.RED + "Error: El puerto debe ser un número entre 1 y 65535.")
                    return  # Retornar si el puerto no es válido
            except ValueError:
                print(Fore.RED + "Error: El puerto debe ser un número válido.")
                return  # Retornar si la conversión a entero falla

            # Crear el socket para el cliente (IPv6)
